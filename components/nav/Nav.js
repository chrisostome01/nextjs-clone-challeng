            ...
            <Layout>
                <div className="flex justify-between  my-[23px]">
                    <div className="flex items-center relative">
                        <img src="/navigation/logoone.svg" className="lg:w-[39px] w-[30px]"  alt="logo one " />
                    ...
                    <div className='flex items-center'>
                        <Button label={'Start The Course'} style={`text-black text-base font-normal lg:text-lg font-primary border-none bg-white hidden lg:block`} />
